...
Assumindo a existência de uma solução ideal e a conversão próxima a fonteira de pareto, o suposto ponto ideal é projetado levando em conta as soluções não dominadas existentes (ou seja, os menores valores dos objetivos). Uma vez feita essa projeção, o ponto escolhido é o de menor distância deste ponto.
...
Em outros experimentos, os autores usam duas funções relacionadas ao teste pelo agente A estrela vencedor da competição da marioAI de 2009, conforme as equações (2.3) e (2.4), onde p é a fração da fase em que o agente passou, e #jumps a quantia de pulos:
