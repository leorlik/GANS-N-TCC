...
\begin{itemize}
    ...
    \item A necessidade de especificar parâmetros, como o de compartilhamento do primeiro NSGA\cite{Deb:94};
\end{itemize}
...
A busca A estrela possui múltiplas aplicações, entre elas a busca por caminhos viáveis em videogames. Até os dias de hoje, o mais popular algoritmo para o teste de jogabilidade de níveis do jogo \textit{}
...
Tanto o discriminador quanto o gerador são treinados com o otimizador RMSprop, com um \textit{batch size} de tamanho 32 e a taxa de aprendizado de 0,00005 por 5000 iterações. A arquitetura é devidamente ilustrada na (Figura Y).
