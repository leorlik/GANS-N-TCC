...
Em outros experimentos, os autores usam duas funções relacionadas ao teste pelo agente A estrela vencedor da competição da mario AI de 2009, conforme as equações (2.3) e (2.4), onde p é a fração da fase em que o agente passou, e #jumps a quantia de pulos:
