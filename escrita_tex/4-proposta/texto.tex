...
Neste trabalho, muitas funções-objetivos foram otimizadas. Foram minimizadas as funções das equações (2.1) e (2.2) seguindo a proposta de progressão de dificuldade em \cite{marioGAN}, e o desempenho do CMA-ES e do PSO foram comparados. para a comparação, foram feitas algumas rodadas de otimização destas funções em conjunto com a presente na equação (2.3) utilizando NSGA-II, para avaliar o desempenho geral. 
...
Como devidamente elicitado por \cite{pcg2013}, uma das maiores dificuldades da PCGML é avaliar o conteúdo gerado proceduralmente. Neste trabalho, foram propostos três métodos de avaliação:
