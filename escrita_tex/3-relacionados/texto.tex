...
Neste capítulo, foram revisitados alguns trabalhos que utilizam conceitos de PCGML, muitos trabalhos estes que utilizam conceitos de \cite{marioGAN}, além de algumas aplicações práticas no início da sessão. Não se limitando a geração de níveis, o objetivo desta sessão foi justificar a importância do aprendizado adversarial na área de PCGML como um todo, área esta bastante aquecida porém recente, sem um estado da arte definido. No próximo capítulo, será apresentada a proposta deste trabalho. 
